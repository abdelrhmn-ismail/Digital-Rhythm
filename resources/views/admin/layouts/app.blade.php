...
<head>
    ...
    <title>@yield('title', 'Admin') - Golden Bee</title>
...
<body class="bg-gray-100 text-gray-900 antialiased">
    <div class="flex min-h-screen">
        ...
        <aside class="admin-sidebar w-64 min-h-screen text-white shadow-xl">
            ...
            <nav class="mt-6">
                <div class="px-4">
                    <h3 class="text-xs uppercase text-gray-300 font-semibold">Main</h3>
                ...
                <div class="px-4 mt-8">
                    <h3 class="text-xs uppercase text-gray-300 font-semibold">Content Management</h3>
                    <div class="mt-3 space-y-1">
                ...
                <div class="px-4 mt-8">
                    <h3 class="text-xs uppercase text-gray-300 font-semibold">System</h3>
                    <div class="mt-3 space-y-1">
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center h-16">
                        ...
                        <div class="flex items-center gap-4">
                            <a href="{{ route('home') }}" class="text-gray-500 hover:text-gray-700" title="View Website">
