    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
            <div class="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-primary mb-2">
                ...
                <span class="text-gray-400">{{ __('EDIT LOGO') }}</span>
            </div>
            <h1 class="text-4xl font-black text-gray-900 tracking-tight">{{ __('Modify Partner') }}</h1>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.partners.update', $partner) }}" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name', $partner->name) }}" required
                                class="w-full px-6 py-4 rounded-2xl bg-gray-50 border-transparent focus:bg-white focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all outline-none font-bold text-gray-900 shadow-inner @error('name') border-red-500 @enderror" placeholder="Enter partner name">
                            @error('name')
                ...
                <x-admin.image-upload 
                    ...
                    :label="__('Update Partner Logo')"
                    :placeholder="__('Click to Change Logo')"
                    aspect="aspect-[4/1]"
                />
            </div>
                ...
                <div class="bg-primary/5 rounded-[40px] p-8 border border-primary/10 space-y-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="number" name="order" value="{{ old('order', $partner->order) }}" min="0"
