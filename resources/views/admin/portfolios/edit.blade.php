...
@section('title', 'Edit Portfolio: ' . $portfolio->getTranslation('title', 'en'))
...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Edit Portfolio Item</h1>
        <p class="text-gray-600 mt-1">Modify project details and translations</p>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        @if($portfolio->thumbnail)
                            <div class="mb-2">
                                <img src="{{ $portfolio->thumbnail_url }}" alt="Thumbnail" class="w-24 h-24 object-cover rounded-lg border">
                            </div>
                        @endif
                        ...
                        @if($portfolio->images)
                            <div class="flex gap-2 mb-2 overflow-x-auto">
                                @foreach($portfolio->images_urls as $url)
                                    <img src="{{ $url }}" class="w-12 h-12 object-cover rounded border">
                                @endforeach
                            </div>
                        @endif
