                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea name="content[en]" rows="4" required
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus-ring-primary focus-ring-primary">{{ old('content.en', $testimonial->getTranslation('content', 'en')) }}</textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="content[ar]" rows="4" required dir="rtl"
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus-ring-primary focus-ring-primary text-right">{{ old('content.ar', $testimonial->getTranslation('content', 'ar')) }}</textarea>
                    </div>
                </div>
