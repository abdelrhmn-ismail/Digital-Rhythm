...
<a href="{{ route('services') }}" {{ $attributes->merge(['class' => 'group relative flex flex-col p-8 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:border-primary/40 hover:bg-white/[0.04] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(245,158,11,0.1)]']) }}>
    <!-- Icon -->
    <div class="mb-6">
    ...
    <ul class="space-y-2 mb-6">
        ...
        <li class="flex items-start gap-2 text-xs text-zinc-400 font-light">
