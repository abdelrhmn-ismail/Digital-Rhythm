<section class="jsx-2ab8fd2717b41d19 py-16 bg-[#020202] overflow-hidden relative">
    ...
    <div class="jsx-2ab8fd2717b41d19 max-w-7xl mx-auto px-6 mb-10 text-center relative z-10">
        ...
        <h2 class="jsx-2ab8fd2717b41d19 text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tighter">
            {{ __('BEHIND THE') }} <span class="jsx-2ab8fd2717b41d19 text-gradient">{{ __('MAGIC') }}</span>
        </h2>
    </div>
    <div dir="ltr" class="jsx-2ab8fd2717b41d19 w-full relative z-10">
        <div class="jsx-2ab8fd2717b41d19 relative w-full overflow-hidden h-[280px] sm:h-[340px] md:h-[420px] lg:h-[480px]">
            <div class="jsx-2ab8fd2717b41d19 marquee-track h-full">
                ...
                <div class="jsx-2ab8fd2717b41d19 marquee-card h-full rounded-[16px] md:rounded-[24px] overflow-hidden bg-zinc-950 border border-white/5 shadow-[0_10px_40px_rgba(0,0,0,0.5)] group relative">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-8">
                        ...
                        <h4 class="text-white font-black text-xl leading-tight">{{ $portfolio->title }}</h4>
                    </div>
                </div>
                @endforeach
            </div>
            <div class="jsx-2ab8fd2717b41d19 pointer-events-none absolute inset-y-0 left-0 w-16 md:w-32 bg-gradient-to-r from-[#020202] to-transparent z-20"></div>
            <div class="jsx-2ab8fd2717b41d19 pointer-events-none absolute inset-y-0 right-0 w-16 md:w-32 bg-gradient-to-l from-[#020202] to-transparent z-20"></div>
        </div>
    </div>
</section>