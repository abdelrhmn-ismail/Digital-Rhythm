<section class="py-32 relative overflow-hidden bg-white/5 border-t border-white/10">
    <div class="absolute inset-0 z-0">
        <div class="absolute inset-0 bg-gradient-to-r from-amber-500/5 to-amber-700/5 backdrop-blur-3xl"></div>
    </div>
