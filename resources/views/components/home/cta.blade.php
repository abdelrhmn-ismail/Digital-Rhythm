    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10" data-aos="fade-up">
        ...
        <div class="flex flex-col sm:flex-row gap-6 justify-center items-center" data-aos="fade-up" data-aos-delay="300">
            ...
            <a href="{{ route('portfolio') }}" 
               class="group inline-flex items-center justify-center gap-3 min-w-[280px] border border-white/20 bg-white/5 hover:bg-white/10 hover:border-primary/40 text-white font-bold px-12 h-16 rounded-full text-lg backdrop-blur-sm transition-all duration-300 hover:scale-105 active:scale-95">
                {{ __('View Our Work') }}
