...
<!-- ============================================
     SECTION 1: HERO
     ============================================ -->
<section class="relative min-h-[75vh] flex items-center justify-center overflow-hidden bg-[#050506]">
    <!-- Background Effects -->
    <div class="absolute inset-0 pointer-events-none">
        <!-- Radial gradient glow -->
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[radial-gradient(ellipse_at_center,_rgba(245,158,11,0.08)_0%,_transparent_60%)]"></div>
        <!-- Grid pattern -->
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 pt-32 pb-20">
        <div class="max-w-5xl mx-auto text-center space-y-12">
            ...
            <!-- Badge -->
            <div class="inline-flex items-center gap-2 px-6 py-2 rounded-full border border-primary/20 bg-primary/5 backdrop-blur-xl text-sm font-bold text-primary mb-4 shadow-[0_0_20px_rgba(245,158,11,0.1)] hover:border-primary/40 transition-all duration-300" 
                 data-aos="fade-down" 
                 data-aos-delay="200">
            ...
            <h1 class="text-4xl xs:text-5xl md:text-8xl lg:text-9xl font-black text-white tracking-tighter leading-[0.85]" 
                data-aos="fade-up" 
                data-aos-delay="300">
                <span class="text-white block mb-2">{{ __('WE ARE') }}</span>
...
<section class="py-24 md:py-32 bg-[#050506] relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="max-w-4xl mx-auto mb-20 text-center flex flex-col items-center">
            ...
            <h2 class="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight tracking-tighter" 
                data-aos="fade-up">
                {{ __('INNOVATION IS NOT') }} <br/> <span class="text-gradient">{{ __('AN ACCIDENT.') }}</span>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div class="space-y-6" data-aos="fade-left" data-aos-delay="200">
                <div class="group p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-primary/20 hover:bg-white/[0.04] transition-all duration-500">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h4 class="text-lg font-bold text-white mb-2">{{ __('From Riyadh to the World') }}</h4>
                ...
                <div class="group p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-primary/20 hover:bg-white/[0.04] transition-all duration-500">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h4 class="text-lg font-bold text-white mb-2">{{ __('Engineering Brands Since 2018') }}</h4>
                            <p class="text-zinc-400 font-light leading-relaxed">
...
<section class="py-24 md:py-32 bg-[#0A0A0C] relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="max-w-4xl mx-auto mb-32 text-center">
            ...
            <h2 class="text-4xl md:text-6xl font-black text-white mb-8 leading-tight tracking-tighter" 
                data-aos="fade-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group relative flex flex-col h-full p-10 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:border-primary/30 hover:bg-white/[0.04] transition-all duration-700 hover:-translate-y-2" 
                 data-aos="fade-up" 
                 data-aos-delay="100">
                <div class="mb-8 relative">
                    <div class="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-primary shadow-[0_0_20px_rgba(245,158,11,0.1)] group-hover:bg-primary group-hover:text-primary-foreground group-hover:shadow-[0_0_30px_rgba(245,158,11,0.3)] group-hover:scale-110 transition-all duration-700">
                        <span class="material-icons text-3xl">verified</span>
                    </div>
                    <span class="absolute -bottom-3 -right-2 text-3xl font-black text-white/[0.03] group-hover:text-primary/[0.08] transition-colors duration-700 tracking-tighter">01</span>
                </div>
                <h3 class="text-xl font-black text-white mb-4 group-hover:text-primary transition-colors duration-500 tracking-tight uppercase">
                    {{ __('PROFESSIONALISM') }}
                </h3>
                <p class="text-zinc-400 leading-relaxed font-light text-sm group-hover:text-zinc-300 transition-colors duration-500">
            ...
            <div class="group relative flex flex-col h-full p-10 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:border-primary/30 hover:bg-white/[0.04] transition-all duration-700 hover:-translate-y-2" 
                ...
                <div class="mb-8 relative">
                    ...
                    <span class="absolute -bottom-3 -right-2 text-3xl font-black text-white/[0.03] group-hover:text-primary/[0.08] transition-colors duration-700 tracking-tighter">02</span>
                </div>
                <h3 class="text-xl font-black text-white mb-4 group-hover:text-primary transition-colors duration-500 tracking-tight uppercase">
                    {{ __('CREATIVITY') }}
                </h3>
            ...
            <div class="group relative flex flex-col h-full p-10 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:border-primary/30 hover:bg-white/[0.04] transition-all duration-700 hover:-translate-y-2" 
                ...
                <div class="mb-8 relative">
                    ...
                    <span class="absolute -bottom-3 -right-2 text-3xl font-black text-white/[0.03] group-hover:text-primary/[0.08] transition-colors duration-700 tracking-tighter">03</span>
                </div>
                <h3 class="text-xl font-black text-white mb-4 group-hover:text-primary transition-colors duration-500 tracking-tight uppercase">
                    {{ __('RESULTS') }}
                </h3>
            ...
            <div class="group relative flex flex-col h-full p-10 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:border-primary/30 hover:bg-white/[0.04] transition-all duration-700 hover:-translate-y-2" 
                ...
                <div class="mb-8 relative">
                    ...
                    <span class="absolute -bottom-3 -right-2 text-3xl font-black text-white/[0.03] group-hover:text-primary/[0.08] transition-colors duration-700 tracking-tighter">04</span>
                </div>
                <h3 class="text-xl font-black text-white mb-4 group-hover:text-primary transition-colors duration-500 tracking-tight uppercase">
                    {{ __('PARTNERSHIP') }}
                </h3>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12" data-aos="fade-up">
            ...
            <div class="text-center group">
                ...
                <div class="text-5xl md:text-7xl font-black text-gradient mb-2 counter" data-target="5" data-suffix="M+">
                    0M+
                </div>
                <div class="text-xs md:text-sm font-bold uppercase tracking-[0.2em] text-zinc-500 group-hover:text-zinc-400 transition-colors">
                    {{ __('Leads Gen') }}
            ...
            <div class="text-center group">
                ...
                <div class="text-5xl md:text-7xl font-black text-gradient mb-2 counter" data-target="12" data-suffix="">
                    0
                </div>
                <div class="text-xs md:text-sm font-bold uppercase tracking-[0.2em] text-zinc-500 group-hover:text-zinc-400 transition-colors">
                    {{ __('Awards Won') }}
...
<section class="py-32 md:py-40 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10" data-aos="fade-up">
        ...
        <h2 class="text-5xl md:text-8xl lg:text-9xl font-black text-white mb-8 leading-[0.85] tracking-tighter" data-aos="fade-up" data-aos-delay="100">
            {{ __('YOUR NEXT') }} <span class="text-gradient">{{ __('SUCCESS STORY') }}</span>
        </h2>

        <!-- Description -->
        <p class="text-xl md:text-2xl text-zinc-400 max-w-3xl mx-auto mb-12 font-light leading-relaxed" data-aos="fade-up" data-aos-delay="200">
