        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div class="col-span-1 md:col-span-12 lg:col-span-5">
                <div class="flex items-center space-x-3 mb-8">
                    ...
                    <span class="text-2xl font-black text-white uppercase tracking-wider">{{ $siteTitle }}</span>
                </div>
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="{{ $socialLinks['facebook'] }}" target="_blank" rel="noopener noreferrer" class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-amber-500 hover:border-amber-500 transition-all duration-300 hover:-translate-y-1">
                        <i class="fab fa-facebook-f text-lg"></i>
                    </a>
                    @endif
                    @if(!empty($socialLinks['twitter']) && $socialLinks['twitter'] !== '#')
                    <a href="{{ $socialLinks['twitter'] }}" target="_blank" rel="noopener noreferrer" class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-amber-500 hover:border-amber-500 transition-all duration-300 hover:-translate-y-1">
                        <i class="fab fa-twitter text-lg"></i>
                    </a>
                    @endif
                    @if(!empty($socialLinks['linkedin']) && $socialLinks['linkedin'] !== '#')
                    <a href="{{ $socialLinks['linkedin'] }}" target="_blank" rel="noopener noreferrer" class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-amber-500 hover:border-amber-500 transition-all duration-300 hover:-translate-y-1">
                        <i class="fab fa-linkedin-in text-lg"></i>
                    </a>
                    @endif
                    @if(!empty($socialLinks['instagram']) && $socialLinks['instagram'] !== '#')
                    <a href="{{ $socialLinks['instagram'] }}" target="_blank" rel="noopener noreferrer" class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-amber-500 hover:border-amber-500 transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="col-span-1 md:col-span-4 lg:col-span-3">
                ...
                <div class="space-y-6">
                    ...
                    <a href="mailto:{{ $contactEmail }}" class="group flex items-center space-x-4">
                        ...
                        <span class="text-zinc-400 font-light group-hover:text-white transition-colors">{{ $contactEmail }}</span>
                    </a>
                    @endif
                    ...
                    <a href="tel:{{ str_replace(' ', '', $contactPhone) }}" class="group flex items-center space-x-4">
                        ...
                        <span class="text-zinc-400 font-light group-hover:text-white transition-colors">{{ $contactPhone }}</span>
                    </a>
                    @endif
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <span class="text-zinc-400 font-light">{{ $contactAddress }}</span>
                    </div>
                    @endif
                </div>
            </div>
