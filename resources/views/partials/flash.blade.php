...
@if($errors->any())
    <div class="mx-auto mt-8 w-11/12 max-w-3xl rounded-full border border-amber-200/60 bg-amber-50/80 px-6 py-3 text-center text-sm font-medium text-amber-900 shadow-sm" role="alert">
