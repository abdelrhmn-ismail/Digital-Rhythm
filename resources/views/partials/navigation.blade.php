...
<header class="fixed top-0 left-0 right-0 z-[100] transition-all duration-500 px-4 pointer-events-none flex justify-center"
    ...
    <div class="relative w-full flex items-center justify-between transition-all duration-700 pointer-events-auto px-4 lg:px-8"
        ...
        <nav class="hidden lg:flex items-center gap-2 p-1">
            ...
            <a class="relative px-5 py-2 text-[11px] font-black uppercase tracking-[0.2em] transition-colors duration-300 {{ $currentRoute == 'services' ? 'text-foreground' : 'text-foreground/60 hover:text-foreground' }}" href="{{ route('services') ?? '#' }}">
            ...
            <a class="relative px-5 py-2 text-[11px] font-black uppercase tracking-[0.2em] transition-colors duration-300 {{ $currentRoute == 'projects' ? 'text-foreground' : 'text-foreground/60 hover:text-foreground' }}" href="{{ route('projects') ?? '#' }}">
                <span class="relative z-10">{{ __('Projects') }}</span>
