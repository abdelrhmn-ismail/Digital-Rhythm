...
<!-- ============================================
     SECTION 1: HERO
     ============================================ -->
<section class="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-[#050506]">
    <!-- Background Effects -->
    <div class="absolute inset-0 pointer-events-none">
        <!-- Radial gradient glow -->
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-[radial-gradient(ellipse_at_center,_rgba(245,158,11,0.12)_0%,_transparent_60%)]"></div>
        <!-- Grid pattern -->
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 pt-32 pb-20">
        <div class="max-w-5xl mx-auto text-center space-y-12">
            ...
            <h1 class="text-4xl xs:text-5xl md:text-8xl lg:text-9xl font-black text-white tracking-tighter leading-[0.85]" 
                data-aos="fade-up" 
                data-aos-delay="300">
                <span class="text-white block mb-2">{{ __('CREATIVE') }}</span>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="mb-32 last:mb-0" data-aos="fade-up">
            ...
            <div class="flex items-center gap-4 mb-12">
                <div class="text-6xl md:text-8xl font-black text-white/5">01</div>
                <div class="h-px flex-1 bg-gradient-to-r from-primary/30 to-transparent"></div>
            </div>
            <h2 class="text-3xl md:text-5xl font-black text-white mb-4 uppercase tracking-tight">
                {{ __('BRANDING & IDENTITY') }}
            </h2>
            <p class="text-lg text-zinc-400 font-light mb-12 max-w-3xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Logo Design -->
                <div class="group p-8 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:border-primary/30 hover:bg-white/[0.04] transition-all duration-500 hover:-translate-y-2">
                    <div class="mb-6">
                        <span class="material-icons text-4xl text-primary">brush</span>
                    </div>
                    <h3 class="text-lg font-bold text-white mb-3 uppercase tracking-wide">
                        {{ __('Logo Design') }}
                    </h3>
        ...
        <div class="mb-32 last:mb-0" data-aos="fade-up">
            <!-- Category Header -->
            <div class="flex items-center gap-4 mb-12">
                <div class="text-6xl md:text-8xl font-black text-white/5">02</div>
                <div class="h-px flex-1 bg-gradient-to-r from-primary/30 to-transparent"></div>
            </div>
            <h2 class="text-3xl md:text-5xl font-black text-white mb-4 uppercase tracking-tight">
        ...
        <div class="mb-32 last:mb-0" data-aos="fade-up">
            <!-- Category Header -->
            <div class="flex items-center gap-4 mb-12">
                <div class="text-6xl md:text-8xl font-black text-white/5">03</div>
                <div class="h-px flex-1 bg-gradient-to-r from-primary/30 to-transparent"></div>
            </div>
            <h2 class="text-3xl md:text-5xl font-black text-white mb-4 uppercase tracking-tight">
        ...
        <div data-aos="fade-up">
            <!-- Category Header -->
            <div class="flex items-center gap-4 mb-12">
                <div class="text-6xl md:text-8xl font-black text-white/5">04</div>
                <div class="h-px flex-1 bg-gradient-to-r from-primary/30 to-transparent"></div>
            </div>
            <h2 class="text-3xl md:text-5xl font-black text-white mb-4 uppercase tracking-tight">
